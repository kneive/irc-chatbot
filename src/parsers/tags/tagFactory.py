...
class TagFactory:
    ...
    def createAnnouncementTag(raw_tags:dict) -> AnnouncementTag:
        ...
        return AnnouncementTag(room_name=raw_tags.get('room-name', None),
                               ...
                               subscriber=int(raw_tags.get('subscriber', '-42')),
                               sub_streak=-42,
                               vip=int(raw_tags.get('vip', '-42')),
                               mod=int(raw_tags.get('mod', '-42')),
                               turbo=-42,
    ...
    def createOneTapGiftRedeemedTag(raw_tags:dict):
        ...
        return OnetapgiftTag(room_name=raw_tags.get('room-name'),
                             ...
                             source_msg_id=raw_tags.get('source-msg-id', None),
                             tmi_sent_ts=int(raw_tags.get('tmi-sent-ts')),
                             msg_param_bits_spent=int(raw_tags.get('msg-param-bits-spent', '-42')),
    ...
    def createPrivmsgTag(raw_tags: dict) -> PrivmsgTag:
        ...
        return PrivmsgTag(room_name=raw_tags.get('room-name'),
                          ...
                          first_msg=int(raw_tags.get('first-msg', '-42')),
                          returning_chatter=int(raw_tags.get('returning-chatter', '-42')),
                          turbo=int(raw_tags.get('turbo', '-42')),
                          msg_content=raw_tags.get('message-content'),
    ...
    def createRaidTag(raw_tags:dict) -> RaidTag:
        ...
        return RaidTag(room_name=raw_tags.get('room-name'),
                       ...
                       msg_param_viewerCount=int(raw_tags.get('msg-param-viewerCount', '-42')),
                       system_msg=raw_tags.get('system-msg'))
    ...
    def createRoomstateTag(raw_tags:dict) -> RoomstateTag:
        ...
        return RoomstateTag(room_id=raw_tags.get('room-id'),
                            emote_only=int(raw_tags.get('emote-only', '-42')),
                            followers_only=int(raw_tags.get('followers-only', '-42')),
                            r9k=int(raw_tags.get('r9k', '-42')),
                            slow_mode=int(raw_tags.get('slow', '-42')),
                            sub_only=int(raw_tags.get('subs-only', '-42')))
    ...
    def createSubgiftTag(raw_tags:dict) -> SubgiftTag:
        ...
        return SubgiftTag(room_name=raw_tags.get('room-name'),
                          ...
                          msg_param_gift_months=int(raw_tags.get('msg-param-gift-months', '-42')),
                          msg_param_months=int(raw_tags.get('msg-param-months', '-42')),
                          msg_param_origin_id=raw_tags.get('msg-param-origin-id'),
                          msg_param_recipient_display_name=raw_tags.get('msg-param-recipient-display-name'),
                          msg_param_recipient_id=raw_tags.get('msg-param-recipient-id'),
                          msg_param_recipient_user_name=raw_tags.get('msg-param-recipient-user-name'),
                          msg_param_sender_count=int(raw_tags.get('msg-param-sender-count', '-42')),
    ...
    def createSubmysterygiftTag(raw_tags:dict) -> SubmysteryTag:
        ...
        return SubmysteryTag(room_name=raw_tags.get('room-name'),
                             ...
                             tmi_sent_ts=int(raw_tags.get('tmi-sent-ts')),
                             msg_param_community_gift_id=raw_tags.get('msg-param-community-gift-id'),
                             msg_param_mass_gift_count=int(raw_tags.get('msg-param-mass-gift-count', '-42')),
                             msg_param_origin_id=raw_tags.get('msg-param-origin-id'),
                             msg_param_sender_count=int(raw_tags.get('msg-param-sender-count', '-42')),
                             msg_param_sub_plan=raw_tags.get('msg-param-sub-plan'),
                             msg_param_goal_contribution_type=raw_tags.get('msg-param-goal-contribution-type'),
                             msg_param_goal_current_contributions=int(raw_tags.get('msg-param-goal-current-contributions', '-42')),
                             msg_param_goal_target_contributions=int(raw_tags.get('msg-param-goal-target-contributions', '-42')),
                             msg_param_goal_user_contributions=int(raw_tags.get('msg-param-goal-user-contributions', '-42')),
                             system_msg=raw_tags.get('system-msg'))
    ...
    def createSubTag(raw_tags:dict) -> SubTag:
        ...
        return SubTag(room_name=raw_tags.get('room-name'),
                      ...
                      source_msg_id=raw_tags.get('source-msg-id', None),
                      tmi_sent_ts=int(raw_tags.get('tmi-sent-ts')),
                      msg_param_cumulative_months=int(raw_tags.get('msg-param-cumulative-months', '-42')),
                      msg_param_months=int(raw_tags.get('msg-param-months', '-42')),
                      msg_param_multimonth_duration=int(raw_tags.get('msg-param-multimonth-duration', '-42')),
                      msg_param_multimonth_tenure=int(raw_tags.get('msg-param-multimonth-tenure', '-42')),
                      msg_param_should_share_streak=int(raw_tags.get('msg-param-should-share-streak', '-42')),
                      msg_param_sub_plan_name=raw_tags.get('msg-param-sub-plan-name'),
                      msg_param_sub_plan=raw_tags.get('msg-param-sub-plan'),
    ...
    def createViewerMilestoneTag(raw_tags:dict) -> ViewerMilestoneTag:
        ...
        return ViewerMilestoneTag(room_name='#unknown',                                  
                                  room_id=raw_tags.get('room-id'),
                                  source_room_name=raw_tags.get('source-room-name', '#unknown'),
                                  source_room_id=raw_tags.get('source-room-id', None),
                                  user_id=raw_tags.get('user-id'),
                                  ...
                                  param_copoReward=int(raw_tags.get('msg-param-copoReward', '-42')),
                                  param_id=raw_tags.get('msg-param-id'),
                                  param_value=int(raw_tags.get('msg-param-value', '-42')),
                                  system_msg=raw_tags.get('system-msg'))